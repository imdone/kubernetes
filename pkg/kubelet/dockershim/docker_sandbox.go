...
func (ds *dockerService) RunPodSandbox(config *runtimeapi.PodSandboxConfig) (id string, err error) {
	...
	// NOTE: To use a custom sandbox image in a private repository, users need to configure the nodes with credentials properly. id:934 gh:940
	...
	// NOTE: cluster dns settings aren't passed anymore to docker api in all cases, id:850 gh:851
	...
	if err != nil {
		// TODO (random-liu): Do we need to teardown network here? id:881 gh:887
...
// TODO: This function blocks sandbox teardown on networking teardown. Is it id:909 gh:915
...
func (ds *dockerService) StopPodSandbox(podSandboxID string) error {
		...
		if checkpointErr != nil {
			if libdocker.IsContainerNotFoundError(statusErr) && checkpointErr == errors.CheckpointNotFoundError {
				...
				if checkpointErr == errors.CorruptCheckpointError {
					...
					// TODO (#43021): Fix this properly. id:844 gh:846
	...
	// TODO: Stop all running containers in the sandbox. id:935 gh:941
}
...
func (ds *dockerService) getIP(podSandboxID string, sandbox *dockertypes.ContainerJSON) string {
	...
	// TODO: trusting the docker ip is not a great idea. However docker uses id:851 gh:852
	...
	// FIXME: handle network errors by restarting the pod somehow? id:882 gh:888
...
func (ds *dockerService) PodSandboxStatus(podSandboxID string) (*runtimeapi.PodSandboxStatus, error) {
	...
	var IP string
	// TODO: Remove this when sandbox is available on windows id:910 gh:916
...
func (ds *dockerService) makeSandboxDockerConfig(c *runtimeapi.PodSandboxConfig, image string) (*dockertypes.ContainerCreateConfig, error) {
	...
	// TODO (random-liu): Deprecate this label once container metrics is directly got from CRI. id:845 gh:847
	...
	createConfig := &dockertypes.ContainerCreateConfig{
		...
		Config: &dockercontainer.Config{
			Hostname: c.Hostname,
			// TODO: Handle environment variables. id:936 gh:942
			Image:  image,
			Labels: labels,
		},
		HostConfig: hc,
...
func setSandboxResources(hc *dockercontainer.HostConfig) {
	...
	// TODO: Get rid of the dependency on kubelet internal package. id:852 gh:853
