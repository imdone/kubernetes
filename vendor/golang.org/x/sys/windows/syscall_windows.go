...
func Read(fd Handle, p []byte) (n int, err error) {
	...
	if e != nil {
		if e == ERROR_BROKEN_PIPE {
			// NOTE (brainman): work around ERROR_BROKEN_PIPE is returned on reading EOF from stdin id:3342 gh:3357
			return 0, nil
		}
		return 0, e
	}
...
func (sa *SockaddrUnix) sockaddr() (unsafe.Pointer, int32, error) {
	// TODO (brainman): implement SockaddrUnix.sockaddr() id:3242 gh:3257
...
// TODO (brainman): fix all needed for net id:3190 gh:3205
...
func FindFirstFile(name *uint16, data *Win32finddata) (handle Handle, err error) {
	// NOTE (rsc): The Win32finddata struct is wrong for the system call: id:3514 gh:3529
...
// TODO (brainman): fix all needed for os id:2908 gh:2923
