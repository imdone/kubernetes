...
func (h *Handle) linkModify(link Link, flags int) error {
	// TODO: support extra data for macvlan id:3116 gh:3131
	base := link.Attrs()
	...
	if tuntap, ok := link.(*Tuntap); ok {
		// TODO: support user id:3216 gh:3226
		// TODO: support group id:2794 gh:2809
		// TODO: multi_queue id:3177 gh:3192
		// TODO: support non- persistent id:3081 gh:3096
		...
		if base.MasterIndex != 0 {
			// TODO: verify MasterIndex is actually a bridge? id:3117 gh:3132
	...
	msg := nl.NewIfInfomsg(syscall.AF_UNSPEC)
	// TODO: make it shorter id:3217 gh:3232
	...
	// can't set master during create, so set it afterwards
	if base.MasterIndex != 0 {
		// TODO: verify MasterIndex is actually a bridge? id:2795 gh:2810
		return h.LinkSetMasterByIndex(link, base.MasterIndex)
	}
	return nil
}
...
func (h *Handle) LinkList() ([]Link, error) {
	// NOTE (vish): This duplicates functionality in net/iface_linux.go, but we need id:3178 gh:3193
...
func parseBondData(link Link, data []syscall.NetlinkRouteAttr) {
	...
	for i := range data {
		...
		case nl.IFLA_BOND_ARP_IP_TARGET:
			// TODO: implement id:3082 gh:3098
		...
		case nl.IFLA_BOND_AD_INFO:
			// TODO: implement id:3118 gh:3133
