...
func (scope *RequestScope) AllowsConversion(gvk schema.GroupVersionKind) bool {
	// TODO: this is temporary, replace with an abstraction calculated at endpoint installation time id:3706 gh:3721
	if gvk.GroupVersion() == metav1alpha1.SchemeGroupVersion {
		...
		case "PartialObjectMetadata", "PartialObjectMetadataList":
			// TODO: should delineate between lists and non-list endpoints id:3794 gh:3810
			return true
		default:
			return false
		}
...
func ConnectResource(connecter rest.Connecter, scope RequestScope, admit admission.Interface, restPath string, isSubresource bool) http.HandlerFunc {
	return func(w http.ResponseWriter, req *http.Request) {
		...
		if admit.Handles(admission.Connect) {
			...
			// TODO: remove the mutating admission here as soon as we have ported all plugin that handle CONNECT id:3990 gh:4010
...
func setSelfLink(obj runtime.Object, requestInfo *request.RequestInfo, namer ScopeNamer) error {
	// TODO: SelfLink generation should return a full URL? id:3423 gh:3438
